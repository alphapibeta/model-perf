## Benchmark report (gpt-oss-20b_20260318_215742 / concurrency)
...
- **Best latency (TTFT p95)**: `concurrency_c1_req128_in512_out160` (c=1) → 122.42 ms
- **Best throughput (out_tps)**: `concurrency_c1024_req1024_in512_out160` (c=1024) → 3174.15 tok/s
