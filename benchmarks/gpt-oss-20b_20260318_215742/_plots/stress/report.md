## Benchmark report (gpt-oss-20b_20260318_215742 / stress)
...
- **Best latency (TTFT p95)**: `stress_c1_req256_in2000_out512` (c=1) → 309.05 ms
- **Best throughput (out_tps)**: `stress_c1024_req1024_in2000_out512` (c=1024) → 2707.59 tok/s
- **Saturation knee (heuristic)**: around c=16 (`stress_c16_req256_in2000_out512`) where TTFT p95 jumps ≥2× vs previous concurrency.
